...
export { HighloadWalletTransactionConfirmer } from './HighloadWalletTransactionConfirmer';
export type { HighloadWalletTransactionConfirmerOptions } from './HighloadWalletTransactionConfirmer';
